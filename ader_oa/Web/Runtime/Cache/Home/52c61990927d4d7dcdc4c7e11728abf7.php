	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($newAdd)): foreach($newAdd as $key=>$v): ?><tr class="text-c">
					...
					<!-- <td class="td-manage"><a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo ($v["zid"]); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td> -->
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '/ader_oa/home/Integral/rules_jian_delete',
			data:{"id":id},
			dataType: 'json',
			success: function(data){
