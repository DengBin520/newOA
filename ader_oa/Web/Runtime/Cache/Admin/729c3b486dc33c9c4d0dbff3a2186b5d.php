...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($newData["oa_project_name"]); ?>" placeholder="" id="projectName" name="projectName">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($newData["oa_company_url"]); ?>" placeholder="" id="companyUrl" name="companyUrl">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>客户姓名：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="<?php echo ($newData["oa_customer_name"]); ?>" placeholder="" id="customerName" name="customerName">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($newData["oa_customer_tel"]); ?>" placeholder="" id="customerTel" name="customerTel">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>不选则（默认）原负责人：</label>
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:31.5%">
			...
			<select class="select" size="1" name="toolUseId" >
				<option value="<?php echo ($newData["oa_head_id"]); ?>" selected>请选择员工</option>
  ...
  <div class="row cl">
      ...
      <input type="text" onfocus="WdatePicker()" id="projectAddtime" name="projectAddtime" class="input-text Wdate" value="<?php echo ($newData["oa_project_add_time"]); ?>">    
    </div>
  </div>
  <div class="row cl">
  	<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>项目结束日期：</label>
  	<div class="formControls col-xs-8 col-sm-3">        
      <input type="text" onfocus="WdatePicker()" id="projectEndtime" name="projectEndtime" class="input-text Wdate" value="<?php echo ($newData["oa_project_end_time"]); ?>">    
    </div>
  </div>
	<!-- <div class="row cl">
   ...
   <!--  <div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="location" type="radio" id="toolState-1" value="0" <?php if($newData["oa_location"] == 0): ?>checked=""<?php endif; ?>>
				<label for="toolState-1">未开时</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="toolState-2" name="location" value="1" <?php if($newData["oa_location"] == 1): ?>checked=""<?php endif; ?>>
				<label for="toolState-2">已进行</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="toolState-3" name="location" value="2" <?php if($newData["oa_location"] == 2): ?>checked=""<?php endif; ?>>
