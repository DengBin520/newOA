...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($newData["oa_tool_name"]); ?>" placeholder="" id="toolName" name="toolName">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>物品编号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="<?php echo ($newData["oa_tool_number"]); ?>" placeholder="" id="toolNumber" name="toolNumber">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($newData["oa_the_number"]); ?>" placeholder="" id="theNumber" name="theNumber">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>物品价格：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="" name="toolPrice" id="toolPrice" value="<?php echo ($newData["oa_tool_price"]); ?>">
		</div>
	</div>
  <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>购买时间</label>
      <div class="formControls col-xs-8 col-sm-3">        
          <input type="text" onfocus="WdatePicker()" id="buyDatatime" name="buyDatatime" class="input-text Wdate" value="<?php echo (date('Y-m-d',$newData["oa_buy_datatime"])); ?>">    
        </div>
      </div>
	<!-- <div class="row cl">
     ...
     <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>物品图片：</label>
    	      <div class="formControls col-xs-8 col-sm-9">
    	        <input type="file" class="" name="toolImg" multiple value="<?php echo ($newData["oa_buy_datatime"]); ?>">
    	      </div>
    </div> 
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>物品状态：</label>
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="toolState" type="radio" id="toolState-1" value="0" <?php if($newData["oa_tool_state"] == 0): ?>checked=""<?php endif; ?>>
				<label for="toolState-1">完好</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="toolState-2" name="toolState" value="1" <?php if($newData["oa_tool_state"] == 1): ?>checked=""<?php endif; ?>>
				<label for="toolState-2">一般</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="toolState-3" name="toolState" value="2" <?php if($newData["oa_tool_state"] == 2): ?>checked=""<?php endif; ?>>
				<label for="toolState-3">旧/坏</label>
			</div>
		</div>
	</div> 
	<!-- <div class="row cl">
	        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>目前使用人：</label>
	    	      <div class="formControls col-xs-8 col-sm-9">
	    	        <input type="text" class="input-text" placeholder="" name="toolPrice" id="toolPrice" value="<?php echo ($newData["oa_user_name"]); ?>" readonly="readonly">
	    	      </div>
	    </div> -->
	<div class="row cl">
	
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>不选默认为原使用人：</label>
			
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:31.5%">
				<input type="text" class="input-text" placeholder="" name="" id="toolPrice" value="<?php echo ($newData["oa_user_name"]); ?>" readonly="readonly">
				<select class="select" size="1" name="toolUseId" >
					<option value="<?php echo ($newData["oa_tool_use_id"]); ?>" selected>请选择员工</option>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>物品特殊情况：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<textarea name="comment" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" ><?php echo ($newData["oa_comment"]); ?></textarea>
