...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户中心 <span class="c-gray en">&gt;</span> 用户管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($adminList)): foreach($adminList as $key=>$v): ?><tr class="text-c">
				...
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('查看信息','','<?php echo ($v["uid"]); ?>','360','400')"><?php echo ($v["oa_user_name"]); ?></u></td>
				<td>
					<?php if($v["oa_sex"] == 0): ?>男
                    <?php elseif($v["oa_sex"] == 1 ): ?>
                        女<?php endif; ?>
				</td>
				<td><?php echo ($v["oa_tel"]); ?></td>
				<td><?php echo ($v["oa_email"]); ?></td>
				<td class="text-l"><?php echo ($v["oa_user"]); ?></td>
				<td><?php echo ($v["oa_position"]); ?></td>
				<td class="td-status"><span class="label label-success radius"><?php echo (date("Y-m-d",$v["oa_entry_time"])); ?></span></td>
				<td class="td-manage">
				<a style="text-decoration:none" onClick="member_admin(this,'<?php echo ($v["uid"]); ?>')" href="javascript:;" title="新增管理员"><i class="Hui-iconfont">&#xe607;</i></a> 
				...
				<a title="编辑" href="javascript:;" onclick="member_edit('编辑','','<?php echo ($v["uid"]); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
				 
				<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo ($v["uid"]); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function member_add(title,url,w,h){
	var url = '/ader_oa/admin/Oa/user_add';
	layer_show(title,url,w,h);
}
/*用户-查看*/
function member_show(title,url,id,w,h){
	url = '/ader_oa/admin/Oa/admin_user_list?uid='+id;
	layer_show(title,url,w,h);
}
/*用户-停用*/
...
function member_edit(title,url,id,w,h){
	url = '/ader_oa/admin/Oa/user_update?uid='+id;
	layer_show(title,url,w,h);
}
/*密码-修改*/
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '/ader_oa/admin/Oa/user_delete',
			data:{"uid":id},
			dataType: 'json',
			success: function(data){
...
/*用户-admin*/
function member_admin(obj,id){
	layer.confirm('确认要添加为管理员？',function(index){
		$.ajax({
			type: 'POST',
			url: '/ader_oa/admin/Oa/user_admin',
			data:{"uid":id},
			dataType: 'json',
			success: function(data){
				$(obj).parents("tr").remove();
